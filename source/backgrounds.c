...
#include "bgGameplayInfo.h" // grit-ek sortzen du
...
{
    // Fondoa kopiatu memorian erakusteko
    ...
    /* Fondoaren paleta kopiatu memorian spritearen kolore egokiak erakutsi
       ahal izateko. */
    dmaCopyHalfWords(DMA_CHANNEL, // Erabiltzeko DMA kanala
 ...
 */
void showSubBgGameplayInfo()
{
    // Fondoa kopiatu memorian erakusteko
    dmaCopyHalfWords(DMA_CHANNEL, // Erabiltzeko DMA kanala
                     bgGameplayInfoBitmap, // Automatikoki sortzen den aldagaia
                     bgGetGfxPtr(bg3Sub), // Bigarren mailako pantailaren 3 fondoaren helbidea
                     bgGameplayInfoBitmapLen); // Luzera (bytetan) automatikoki sortzen den aldagaia
    
    /* Fondoaren paleta kopiatu memorian spritearen kolore egokiak erakutsi
       ahal izateko. */
    dmaCopyHalfWords(DMA_CHANNEL, // Erabiltzeko DMA kanala
                     bgGameplayInfoPal, // Automatikoki sortzen den aldagaia
                     BG_PALETTE_SUB, // Bigarren mailako pantailaren fondoen paletaren helbidea
                     bgGameplayInfoPalLen); // Luzera (bytetan) automatikoki sortzen den aldagaia
}